...
def scrape_against_possession():
    ...
    df.to_csv("laliga/pass/barcelona_pass_against.csv", index=False)
    print(df.head())
    print(f"Total {len(df)} baris disimpan ke barcelona_pass_against.csv")
