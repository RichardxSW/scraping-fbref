...
df_excel = pd.read_excel("premier2425.xlsx")  # ganti nama file sesuai punya kamu

# 2. Load data hasil scraping FBref
df_fbref = pd.read_csv("premier_league_xg.csv")
...
df_merged.to_excel("data_football_uk_with_xg.xlsx", index=False)
