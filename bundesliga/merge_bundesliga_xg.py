...
df_excel = pd.read_excel("bundesliga/bundesliga24251.xlsx")  # ganti nama file sesuai punya kamu

# 2. Load data hasil scraping FBref
df_fbref = pd.read_csv("bundesliga/bundesliga_xg.csv")
...
df_merged.to_excel("bundesliga/bundesliga_updated_xg.xlsx", index=False)

print("Selesai! Data sudah disimpan ke bundesliga_updated_xg.xlsx")
